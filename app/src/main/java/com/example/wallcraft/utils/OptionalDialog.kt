...
class OptionalDialog(context: Context) : AlertDialog(context) {
    ...
    private fun initDialogContentView() {
        ...
        shape.color = AppCompatResources.getColorStateList(context, R.color.lotion)
    ...
    private fun addOption(text: String?, listener: OptionalDialogClickListener?) {
        ...
        option.setTextColor(ContextCompat.getColor(context, R.color.chineseBlack))
    ...
    private fun addTwoOptions() {
        ...
        firstOptionTxtView.setTextColor(ContextCompat.getColor(context, R.color.chineseBlack))
        ...
        secondOptionTxtView.setTextColor(ContextCompat.getColor(context, R.color.chineseBlack))
